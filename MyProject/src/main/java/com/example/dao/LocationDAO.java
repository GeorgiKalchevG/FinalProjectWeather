...
public class LocationDAO implements ILocationDAO {
	...
	public ArrayList<HourForcast> getDayFromWUnderground(String country, String city, String language,User user) {
		...
		String wundergroungUrl = "http://api.wunderground.com/api/d1141c29f3b4adb3/hourly/q/"
	...
	public ArrayList<ArrayList<DayForcast>> getFiveDaysFromWUnderground(String country, String city, String language,User user) {
		...
		String wundergroungUrl = "http://api.wunderground.com/api/d1141c29f3b4adb3/forecast10day/q/" + country.replace(' ', '_') + "/" + city.replace(' ', '_') + ".json";		JsonObject weatherData = new JsonParser().parse(restTemplate.getForObject(wundergroungUrl, String.class))
				.getAsJsonObject();
	...
	public String plannerResponse(String from, String to, String city, String country) {
		String url = "http://api.wunderground.com/api/d1141c29f3b4adb3/planner_" + from.split("/")[0]
